...
class TestWebTool:
    ...
    async def test_fetch_binary_rejected(self):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await tool.execute(action="fetch", url="https://example.com/file.exe")
    ...
    async def test_extract_success(self):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await tool.execute(action="extract", url="https://example.com")
            
            assert result.ok
            assert "content" in result.content.lower() or "Main" in result.content
    ...
    def test_domain_allowlist(self):
        ...
        result = tool._sanitizer.sanitize_url("https://notallowed.com")
